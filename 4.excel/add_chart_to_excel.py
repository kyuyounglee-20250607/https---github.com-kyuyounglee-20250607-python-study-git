...
# 1. 기존 엑셀 파일 읽기
input_excel_file = 'd:\\week_src\\4.excel\\product_report_by_region.xlsx'
df = pd.read_excel(input_excel_file, sheet_name='데이터')

# 2. 차트를 추가할 새로운 엑셀 파일 설정
output_excel_file = 'd:\\week_src\\4.excel\\product_report_with_chart.xlsx'
